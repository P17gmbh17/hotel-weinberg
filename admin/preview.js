...
var WeinbergIndexPreview = createClass({
  render: function () {
    ...
    var LIVE_URL = 'https://benevolent-cranachan-01009f.netlify.app/de/index.html';
    var html = '';
...
var WeinbergZimmerPreview = createClass({
  render: function () {
    ...
    var LIVE_URL = 'https://benevolent-cranachan-01009f.netlify.app/de/zimmer.html';
    var html = '';
...
var WeinbergGeniessenPreview = createClass({
  render: function () {
    ...
    var LIVE_URL = 'https://benevolent-cranachan-01009f.netlify.app/de/geniessen.html';
    var html = '';
...
var WeinbergKulinarikPreview = createClass({
  render: function () {
    ...
    var LIVE_URL = 'https://benevolent-cranachan-01009f.netlify.app/de/kulinarik.html';
    var html = '';
...
var WeinbergPhilosophiePreview = createClass({
  render: function () {
    ...
    var LIVE_URL = 'https://benevolent-cranachan-01009f.netlify.app/de/philosophie.html';
    var html = '';
...
var WeinbergKontaktPreview = createClass({
  render: function () {
    ...
    var LIVE_URL = 'https://benevolent-cranachan-01009f.netlify.app/de/kontakt.html';
    var html = '';
